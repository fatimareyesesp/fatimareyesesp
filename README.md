...
* **Visualización de datos (Cálculo Energético):** Implementé la lógica visual para transformar datos complejos de consumo en una interfaz comprensible, sugiriendo la cantidad ideal de paneles mediante una herramienta intuitiva.
